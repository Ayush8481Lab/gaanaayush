...
export const gaanaService = {
  ...
  // Search operations (Updated to accept string | number for limit)
  searchSongs: (q: string, limit: string | number, language?: string) => searchService.searchSongs(q, limit, language),
